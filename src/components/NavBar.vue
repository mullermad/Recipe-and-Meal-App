<template>
    <header class="bg-white h-16 shadow-sm flex justify-between items-stretch">

        <router-link :to="{name:'home'}" class="ml-3 text-lg px-5 inline-flex items-center">Home</router-link>
